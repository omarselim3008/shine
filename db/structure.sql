...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@zappistore\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20170702084533');

INSERT INTO schema_migrations (version) VALUES ('20170708131038');

INSERT INTO schema_migrations (version) VALUES ('20170708135712');

INSERT INTO schema_migrations (version) VALUES ('20170709072838');

INSERT INTO schema_migrations (version) VALUES ('20170727102937');

INSERT INTO schema_migrations (version) VALUES ('20170727143315');

INSERT INTO schema_migrations (version) VALUES ('20170727170154');
